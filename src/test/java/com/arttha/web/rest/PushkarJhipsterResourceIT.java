 ...
 */
@SpringBootTest(classes = JhipsterApp3App.class)
public class PushkarJhipsterResourceIT {
    ...
    /**
     * This repository is mocked in the com.arttha.repository.search test package.
     *
     * @see com.arttha.repository.search.PushkarJhipsterSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createPushkarJhipster() throws Exception {
        ...
        // Validate the PushkarJhipster in Elasticsearch
        verify(mockPushkarJhipsterSearchRepository, times(1)).save(testPushkarJhipster);
    }
    ...
    public void createPushkarJhipsterWithExistingId() throws Exception {
        ...
        // Validate the PushkarJhipster in Elasticsearch
        verify(mockPushkarJhipsterSearchRepository, times(0)).save(pushkarJhipster);
    }
    ...
    public void updatePushkarJhipster() throws Exception {
        ...
        reset(mockPushkarJhipsterSearchRepository);
    ...
    public void deletePushkarJhipster() throws Exception {
        ...
        // Validate the PushkarJhipster in Elasticsearch
        verify(mockPushkarJhipsterSearchRepository, times(1)).deleteById(pushkarJhipster.getId());
    }

    @Test
    @Transactional
    public void searchPushkarJhipster() throws Exception {
        // Initialize the database
        pushkarJhipsterService.save(pushkarJhipster);
        when(mockPushkarJhipsterSearchRepository.search(queryStringQuery("id:" + pushkarJhipster.getId())))
            .thenReturn(Collections.singletonList(pushkarJhipster));
        // Search the pushkarJhipster
        restPushkarJhipsterMockMvc.perform(get("/api/_search/pushkar-jhipsters?query=id:" + pushkarJhipster.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
            .andExpect(jsonPath("$.[*].id").value(hasItem(pushkarJhipster.getId().intValue())))
