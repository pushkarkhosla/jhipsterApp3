...
public class BookEntityResource {
    ...
    /**
     * {@code SEARCH  /_search/book-entities?query=:query} : search for the bookEntity corresponding
     * to the query.
     *
     * @param query the query of the bookEntity search.
     * @return the result of the search.
     */
    @GetMapping("/_search/book-entities")
    public List<BookEntity> searchBookEntities(@RequestParam String query) {
        log.debug("REST request to search BookEntities for query {}", query);
        return bookEntityService.search(query);
    }
