...
public class PushkarJhipsterResource {
    ...
    /**
     * {@code SEARCH  /_search/pushkar-jhipsters?query=:query} : search for the pushkarJhipster corresponding
     * to the query.
     *
     * @param query the query of the pushkarJhipster search.
     * @return the result of the search.
     */
    @GetMapping("/_search/pushkar-jhipsters")
    public List<PushkarJhipster> searchPushkarJhipsters(@RequestParam String query) {
        log.debug("REST request to search PushkarJhipsters for query {}", query);
        return pushkarJhipsterService.search(query);
    }
