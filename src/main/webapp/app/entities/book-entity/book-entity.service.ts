...
export class BookEntityService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/book-entities';
  ...
  search(req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IBookEntity[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
